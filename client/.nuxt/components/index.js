...
export const LazyModalLoginAndRegister = import('../../components/Modal/LoginAndRegister.vue' /* webpackChunkName: "components/modal-login-and-register" */).then(c => wrapFunctional(c.default || c))
export const LazyModalRegister = import('../../components/Modal/Register.vue' /* webpackChunkName: "components/modal-register" */).then(c => wrapFunctional(c.default || c))
